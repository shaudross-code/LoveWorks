        ...
        <DialogContent className="bg-[#121214] border-yellow-400/20 text-white rounded-2xl" aria-describedby={undefined}>
          {dialog?.mode === "assign" ? (
            ...
            <>
              <DialogHeader>
                <DialogTitle className="font-display text-2xl flex items-center gap-2">
                  <Pencil className="w-5 h-5 text-yellow-400" /> Edit goal
                </DialogTitle>
              </DialogHeader>
              <div className="space-y-4">
                <div className="text-sm text-zinc-400">Update anything — title, photo, deadline, product link, target, period, allocation %, and teammates.</div>
                {/* Image */}
                <div>
                ...
                <div>
                  ...
                  <Input data-testid="edit-title" value={editForm.title}
                    ...
                    placeholder="e.g., Save up for boots"
                    className="mt-2 bg-zinc-900 border-zinc-800 text-white rounded-xl h-11" />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                  ...
                  <div>
                    <label className="text-xs uppercase tracking-widest text-zinc-500 inline-flex items-center gap-1"><ExternalLink className="w-3 h-3" /> Product link</label>
