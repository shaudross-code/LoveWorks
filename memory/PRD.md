...
- **Native push (in progress)**: FCM/APNs playbook obtained; awaiting user's Firebase project files (google-services.json, service-account JSON, GoogleService-Info.plist) before implementing @capacitor/push-notifications + firebase-admin send path.
