...
- **Store assets (Jun 2026)**: 18 App Store screenshots (1290x2796, sandbox demo data, `/app/appstore_screenshots/`, guide at `/app/APPSTORE_SCREENSHOTS_GUIDE.md`); Google Play feature graphic 1024x500 at `/app/playstore_assets/feature_graphic_1024x500.png` (also served at `/feature_graphic_1024x500.png`).
